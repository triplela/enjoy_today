export type People = 'solo' | 'small' | 'group' | 'any';
...
export const categories: Category[] = [
  ...
  },
  {
    ...
    icon: 'bath',
    activities: [
      { name: '听音乐', location: 'indoor', people: soloSmallPeople, icon: 'boom-box', apps: ['app'] },
  ...
  },
  {
    ...
    activities: [
      ...
      { name: '运动户外店', location: 'outdoor', people: anyPeople, icon: 'tent', apps: ['app'] },
  ...
  },
  {
    ...
    activities: [
      ...
      { name: '动物园', location: 'outdoor', people: soloSmallPeople, icon: 'dog', apps: ['app'] },
      ...
      { name: '海洋馆', location: 'outdoor', people: soloSmallPeople, icon: 'shrimp', apps: ['app'] },
  ...
  },
  {
    ...
    activities: [
      ...
      { name: '学几个单词', location: 'indoor', people: soloPeople, icon: 'book-a', apps: ['app'] },
      { name: '学一门新语言', location: 'indoor', people: soloPeople, icon: 'book-type', apps: ['app'] },
  ...
  },
  {
    ...
    activities: [
      ...
      { name: '做陶艺', location: 'both', people: soloSmallPeople, icon: 'amphora', apps: ['app'] },
      ...
      { name: '做滴胶', location: 'indoor', people: soloSmallPeople, icon: 'square-star', apps: ['app'] },
      ...
      { name: '做模型', location: 'both', people: soloSmallPeople, icon: 'shapes', apps: ['app'] },
      { name: '玩乐高', location: 'both', people: soloSmallPeople, icon: 'toy-brick', apps: ['app'] },
      { name: '玩拼图', location: 'indoor', people: soloSmallPeople, icon: 'puzzle', apps: ['app'] },
      { name: '绣十字绣', location: 'indoor', people: soloPeople, icon: 'spool', apps: ['app'] },
      { name: '织围巾', location: 'indoor', people: soloPeople, icon: 'spool', apps: ['app'] },
      { name: '钩针编织', location: 'indoor', people: soloPeople, icon: 'shirt', apps: ['app'] },
      { name: '做手账', location: 'indoor', people: soloPeople, icon: 'book-open', apps: ['app'] },
      { name: '做书签', location: 'indoor', people: soloPeople, icon: 'bookmark', apps: ['app'] },
      { name: '写书法', location: 'indoor', people: soloPeople, icon: 'languages', apps: ['app'] },
      ...
      { name: '做微缩模型', location: 'indoor', people: soloSmallPeople, icon: 'toolbox', apps: ['app'] },
  ...
  },
  {
    ...
    icon: 'dumbbell',
    activities: [
      { name: '打台球', location: 'outdoor', people: smallGroupPeople, icon: 'circle-pile', apps: ['app'] },
      { name: '打保龄球', location: 'outdoor', people: smallGroupPeople, icon: 'circle', apps: ['app'] },
      { name: '开卡丁车', location: 'outdoor', people: anyPeople, icon: 'car', apps: ['app'] },
      { name: '玩飞盘', location: 'outdoor', people: smallGroupPeople, icon: 'loader-pinwheel', apps: ['app'] },
      { name: '体验射箭', location: 'outdoor', people: soloSmallPeople, icon: 'bow-arrow', apps: ['app'] },
      ...
      { name: '打网球', location: 'outdoor', people: smallPeople, icon: 'eclipse', apps: ['app'] },
      { name: '打羽毛球', location: 'outdoor', people: smallPeople, icon: 'target', apps: ['app'] },
      { name: '打乒乓球', location: 'outdoor', people: smallPeople, icon: 'hand-coins', apps: ['app'] },
      ...
      { name: '打排球', location: 'outdoor', people: groupPeople, icon: 'volleyball', apps: ['app'] },
